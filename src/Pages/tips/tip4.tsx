...
export default function Tip1(){
    return(
        <div className={styles.contentPlaygame}>
            <br/><br/><br/>
            <h1 id={styles.questionTittle}>Pergunta 4: Tema Código de barras.  </h1>
            <br/><br/>
            <div className={styles.questionBox}>
                <p id="textQuestion">Primeira dica: Formato digital  </p>
            </div><br/>
            <div className={styles.questionBox}>
                <p id="textQuestion">Segunda dica: Representação NF </p>
            </div><br/>
            <div className={styles.questionBox}>
                <p id="textQuestion">Terceira dica:  Contém todas as informações necessárias para empresa.</p>
            </div>
            <br/><br/>
